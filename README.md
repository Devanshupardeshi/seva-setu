...
[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-seva--setu--4ew2.vercel.app-FF6B35?style=flat-square)](https://seva-setu-4ew2.vercel.app/)
...
[![SDG 3](https://img.shields.io/badge/SDG_3-Good_Health-4C9F38?style=flat-square)](https://sdgs.un.org/goals/goal3)
...
graph TB
    ...
    subgraph Edge["🔐 Edge & Auth"]
        E[Firebase Auth · Phone OTP]
        F[Next.js Middleware · Route Protection]
    end

    subgraph AI["🤖 AI Layer"]
        G["Gemini 2.5 Flash\nVoice → Profile · Need Parsing\nBriefing · Report Generation"]
        H["Vertex AI Vector Search\nSemantic Matching · Sub-second"]
        I["text-embedding-004\n768-dim vectors"]
    end

    subgraph Data["💾 Data Layer"]
        J[Cloud Firestore\nUsers · NGOs · Matches · Incidents]
        K[BigQuery · Impact Analytics]
        L[Cloud Storage · Audio · PDFs]
    end

    subgraph Google["🗺️ Google APIs"]
        M[Maps Platform · Routes · Geofencing · Heatmap]
        N[Firebase Cloud Messaging · Push · SMS]
        O[Pub/Sub · Event Bus]
    end
...
<img src="https://raw.githubusercontent.com/Devanshupardeshi/seva-setu/master/public/logo.png" alt="SevaSetu" width="60" />
...
[![GitHub stars](https://img.shields.io/github/stars/Devanshupardeshi/seva-setu?style=social)](https://github.com/Devanshupardeshi/seva-setu/stargazers)
